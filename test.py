...
class EnhancedMarkdownEditor:
    ...
    def setup_ui(self):
        ...
        # 预览文本
        self.preview_text = PreviewFrame(self.preview_paned)
        self.preview_paned.add(self.preview_text, weight=3)
    ...
    def update_preview(self):
        ...
        try:
            self.preview_text.update_preview(content)
        except Exception as e:
            self.preview_text.update_preview(f"预览不可用\n错误信息: {str(e)}")
    ...
    def export_html(self):
        try:
            ...
            if file_path:
                ...
                full_html = self.wrap_full_html(html).replace("预览", file_name)
